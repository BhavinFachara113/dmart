...
<?php
  ...
  {
    $id=$_GET['btn_delete'];
    $delete="DELETE FROM detergent_and_fabric where Id='$id';";
    $s=$c->query($delete);
  }
?>
...
<?php
  if(isset($_GET['btn_approved']))
  {
    ...
    $s=1;
    $approved="UPDATE detergent_and_fabric SET Status='$s' where Id='$id';";
    $a=$c->query($approved);
  }
?>
...
<?php
  if(isset($_GET['btn_reject']))
  {
    $id=$_GET['btn_reject'];
    $s=0;
    $reject="UPDATE detergent_and_fabric SET Status='$s' where Id='$id';";
    $a=$c->query($reject);
  }
?>
...
<body>
    ...
    background-size: cover;">
     <div id="product_add_new_data"> <a href="./add_detergent_and_fabric.php" id="product_add_new_data_msg"><img id="product_add_new_data_img" src="./img/add1.jpg" alt="">ADD NEW</a></div>
      <table id="product_data_display_table">
       <tr>
           ...
           <th id="product_data_display_table_th">Weight</th>
       ...
       <?php
         $select="select* from detergent_and_fabric";
         $data=$c->query($select);
         while($row=$data->fetch_assoc())
         {
           ...
           <tr>
               ...
               <td id="product_data_display_td"><?php echo $row['Weight'];?></td>
               ...
               <td id="product_data_display_td"><a href="edit_detergent_and_fabric.php?btn_edit=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_updata" src="./img/updata1.jpg" alt=""></a><a href="detergent_and_fabric.php?btn_delete=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_delete" src="./img/delete.jpg" alt=""></a><a href="detergent_and_fabric.php?btn_approved=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_appoved" src="./img/appoved.jpg" alt=""></a><a href="detergent_and_fabric.php?btn_reject=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_reject" src="./img/reject.jpg" alt=""></a></td>
           </tr>
           <?php
         }
        ?>       
