...
if (isset($_POST['add_product'])) {
    ...
    echo $buy_1_get_1;
    $insert = "UPDATE detergent_and_fabric SET Name='$name', Sort_Name='$sname', Brand_Name='$brand', Image='$image', Weight='$weight', MRP='$mrp', Dmart='$dmart', Save='$save', Buy_1_Get_1='$buy_1_get_1', Quantity='$quentity', Discripation='$discripation' ,Status='$status' where Id='$id'";
    $s = $c->query($insert);
?>
    <script>
...
<body>
    ...
    background-size: cover;">
        ...
        <?php
        $id = $_GET['btn_edit'];
        $select = "select * from detergent_and_fabric where Id='$id';";
