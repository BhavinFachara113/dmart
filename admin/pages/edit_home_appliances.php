...
if (isset($_POST['add_product'])) {
    ...
    echo $buy_1_get_1;
    $insert = "UPDATE home_appliances SET Name='$name', Sort_Name='$sname', Brand_Name='$brand', Image='$image', Voltage='$voltage', MRP='$mrp', Dmart='$dmart', Save='$save', BUY_1_GET_1='$buy_1_get_1', Quantity='$quentity', Discripation='$discripation' ,Status='$status' where Id='$id'";
    $s = $c->query($insert);
?>
    <script>
...
<body>
    ...
    background-size: cover;">
        ...
        <?php
        $id = $_GET['btn_edit'];
        $select = "select * from home_appliances where Id='$id';";
        ...
        <form id="new_product_form" action="" method="post">
            ...
            <input type="text" id="new_product_form_weight" value="<?php echo $row['Voltage']; ?>" name="p_voltage" required><br>
