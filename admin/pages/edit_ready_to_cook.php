...
if (isset($_POST['add_product'])) {
    ...
    echo $buy_1_get_1;
    $insert = "UPDATE ready_to_cook SET Name='$name', Sort_Name='$sname', Brand_Name='$brand', Image='$image', Weight='$weight', MRP='$mrp', Dmart='$dmart', Save='$save', Buy_1_Get_1='$buy_1_get_1', Quantity='$quentity', Discripation='$discripation' ,Status='$status' where Id='$id'";
    $s = $c->query($insert);
?>
    <script>
