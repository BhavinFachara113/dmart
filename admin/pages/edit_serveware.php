...
if (isset($_POST['add_product'])) {
    ...
    echo $buy_1_get_1;
    $insert = "UPDATE serveware SET Name='$name', Sort_Name='$sname', Brand_Name='$brand', Image='$image', Pieces='$pieces', MRP='$mrp', Dmart='$dmart', Save='$save', Buy_1_Get_1='$buy_1_get_1', Quantity='$quentity', Discripation='$discripation' ,Status='$status' where Id='$id'";
    $s = $c->query($insert);
?>
    <script>
...
<body>
    ...
    background-size: cover;">
        ...
        <?php
        $id = $_GET['btn_edit'];
        $select = "select * from serveware where Id='$id';";
        ...
        <form id="new_product_form" action="" method="post">
            ...
            <input type="text" id="new_product_form_weight" value="<?php echo $row['Pieces']; ?>" name="p_pieces" required><br>
            ...
            if ($row['Buy_1_Get_1'] == "Yes")
             {
               ?>
                ...
                <input type="radio" name="p_buy_1_get_1" id="new_product_form_buy"  value="Yes"  checked="true" required>YES
            ...
            <input type="radio" name="p_buy_1_get_1" id="new_product_form_buy"  value="No"  checked = "true" required>NO <br>
            <?php
            }
            ?>
