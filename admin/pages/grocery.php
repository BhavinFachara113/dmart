...
<?php
  if(isset($_GET['btn_approved']))
  {
    ...
    $s=1;
    $approved="UPDATE grocery SET Status='$s' where Id='$id';";
    $a=$c->query($approved);
  }
?>
...
<?php
  if(isset($_GET['btn_reject']))
  {
    $id=$_GET['btn_reject'];
    $s=0;
    $reject="UPDATE grocery SET Status='$s' where Id='$id';";
    $a=$c->query($reject);
  }
?>
...
<body>
    ...
    background-size: cover;">
     <div id="product_add_new_data"> <a href="./add_grocery.php" id="product_add_new_data_msg"><img id="product_add_new_data_img" src="./img/add1.jpg" alt="">ADD NEW</a></div>
       ...
       <?php
         ...
         while($row=$data->fetch_assoc())
         {
           ...
           <tr>
               ...
               <td id="product_data_display_td"><a href="edit_grocery.php?btn_edit=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_updata" src="./img/updata1.jpg" alt=""></a><a href="grocery.php?btn_delete=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_delete" src="./img/delete.jpg" alt=""></a><a href="grocery.php?btn_approved=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_appoved" src="./img/appoved.jpg" alt=""></a><a href="grocery.php?btn_reject=<?php echo $row['Id'];?>"><img id="product_data_display_td_option_reject" src="./img/reject.jpg" alt=""></a></td>
           </tr>
           <?php
         }
        ?>       
