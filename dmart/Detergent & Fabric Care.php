                ...
                <form method="post" action="menege_cart.php">
                    <div id="product">
                        <div id="product_buy_and_veg">
                            ...
                            ?>
                                <img id="buy_one_get_one" style="margin-left:280px;" src="./img/product/50_off_logo.jpg" alt="">
                            <?php
                            }
                            ?>
                        </div>
                        <a href="detergent_and_fabric_detail.php?btn_show=<?php echo $row['Id']; ?>"><img id="product_img" src="<?php echo $row['Image'] ?>" alt=""></a>
